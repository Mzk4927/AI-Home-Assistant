...
class RealTimeAIHomeAssistant:
    """Real-time AI Home Assistant with live detection and immediate Q&A"""
    
    def __init__(self, model_path: str = "yolo11n.pt"):
        self.object_detector = ObjectDetector(model_path, confidence_threshold=0.25)  # Lower threshold
        ...
        self.latest_detections = []  # Store latest detections for real-time questions
        self.detection_lock = threading.Lock()  # Thread safety
        
    def start(self, camera_index: int = 0):
        """Start the home assistant system"""
        print("🤖 Starting Real-Time AI Home Assistant...")
...
def main():
    """Main function to run the real-time home assistant"""
    assistant = RealTimeAIHomeAssistant()
    ...
    try:
        ...
        print("\n" + "="*60)
        print("💬 REAL-TIME INTERACTIVE MODE")
        print("="*60)
        print("Ask me questions about objects I'm detecting RIGHT NOW!")
        print("Examples:")
